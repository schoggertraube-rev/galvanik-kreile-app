        ...
        {canManageUsers && (
          <>
            ...
            <TabButton
              ...
              label="Geräte & Sessions"
            />
            <TabButton
              active={activeTab === "textvorlagen"}
              onClick={() => setActiveTab("textvorlagen")}
              icon={<Settings />}
              label="Textvorlagen & E-Mails"
            />
            {canManageToggles && (
              <TabButton
            ...
            {activeTab === "system" && (
              <div className="p-12 text-center border-2 border-dashed border-neutral-gray-200 rounded-2xl text-text-muted space-y-4">
                ...
                <p className="text-sm max-w-md mx-auto">
                  Globale Parameter, API-Keys und weitere Funktionen, die nicht
                  im Standardmenü Platz finden.
                </p>
              </div>
            )}
          </>
