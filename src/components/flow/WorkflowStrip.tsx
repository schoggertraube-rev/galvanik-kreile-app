...
export function WorkflowStrip() {
  return (
    <div className="w-full bg-kreile-sand rounded-3xl mb-8 overflow-hidden relative border border-[#EDE8E1]">
      ...
      <div className="relative flex items-center justify-between px-6 md:px-16 py-7">
        ...
        <div className="flex flex-col items-center gap-2.5">
          <span className="text-xs font-black text-kreile-navy uppercase tracking-wider">Wareneingang</span>
          <div className="w-[110px] h-[75px] bg-white rounded-2xl border border-kreile-border shadow-sm flex items-center justify-center transition-transform hover:scale-102">
        ...
        <div className="flex flex-col items-center gap-2.5">
          <span className="text-xs font-black text-kreile-navy uppercase tracking-wider">Galvanik</span>
          <div className="relative w-[110px] h-[75px] bg-white rounded-2xl border border-kreile-border shadow-sm flex items-center justify-center transition-transform hover:scale-102">
            ...
            <span className="absolute -top-1.5 -right-1.5 w-4 h-4 bg-status-red rounded-full border-2 border-white shadow-sm" />
          </div>
        </div>
        ...
        {/* Warenausgang */}
        <div className="flex flex-col items-center gap-2.5">
          <span className="text-xs font-black text-kreile-navy uppercase tracking-wider">Warenausgang</span>
          <div className="w-[110px] h-[75px] bg-white rounded-2xl border border-kreile-border shadow-sm flex items-center justify-center transition-transform hover:scale-102">
            <svg viewBox="0 0 24 24" fill="none" stroke="#001B38" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10">
