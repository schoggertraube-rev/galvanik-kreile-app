...
const ORDER_HIT: SearchHit = {
  ...
  matchValue: "A-2026-0042", context: "A-2026-0042 · Muster GmbH · Termin 18.09.2026", actionLabel: "Auftragskarte öffnen",
};
const STAMP = "2026-09-16T08:15:00.000Z";
const ok = (hits: SearchHit[], query = "xx"): SearchTenantResult => ({ code: "OK", query, hits, checkedSources: ["Auftragsbestand", "Kundenstamm"], checkedAt: STAMP });
