...
vi.mock("../legacy-ui/GalvanikHandoffAttachmentPanel", () => ({
  GalvanikHandoffAttachmentPanel: () => null,
}));
vi.mock("../legacy-ui/GalvanikCorrectionButton", () => ({
...
import { OrderWideCard } from "../legacy-ui/OrderWideCard";
import { OrderCompactCard } from "../legacy-ui/OrderCompactCard";
