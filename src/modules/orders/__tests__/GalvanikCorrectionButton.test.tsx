...
import {
  GalvanikCorrectionButton as ModuleGalvanikCorrectionButton,
...
function GalvanikCorrectionButton(props: Omit<GalvanikCorrectionButtonProps, "ports">) {
  return (
    <ModuleGalvanikCorrectionButton
      {...props}
      ports={{
        correct: correctSpy,
