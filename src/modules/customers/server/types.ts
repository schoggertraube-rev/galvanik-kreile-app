...
export type CustomerOrderItem = { id:string; orderNumber:string; title:string; station:string; status:string; dueAt:string|null };
export type CustomerCardModel = { id:string; customerNumber:string|null; name:string; companyName:string|null; type:string; contactPerson:string|null; email:string|null; phone:string|null; address:string|null; zipCode:string|null; city:string|null; country:string|null; classification:string|null; notes:string|null; tags:string[]; orderCount:number; wareImHausCount:number; orders:CustomerOrderItem[] };
