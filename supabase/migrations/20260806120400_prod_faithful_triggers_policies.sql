...
CREATE POLICY tenant_isolation ON public.arbeitszeit_buchung AS PERMISSIVE FOR ALL TO - USING ((tenant_id = current_setting('app.tenant_id'::text, true)));
DROP POLICY IF EXISTS "Allow full access to audit_log" ON public.audit_log;
CREATE POLICY "Allow full access to audit_log" ON public.audit_log AS PERMISSIVE FOR ALL TO - USING (true) WITH CHECK (true);
DROP POLICY IF EXISTS tenant_isolation ON public.ausgangsrechnung;
CREATE POLICY tenant_isolation ON public.ausgangsrechnung AS PERMISSIVE FOR ALL TO - USING (((tenant_id)::text = current_setting('app.tenant_id'::text, true)));
DROP POLICY IF EXISTS tenant_isolation ON public.ausgangsrechnung_position;
CREATE POLICY tenant_isolation ON public.ausgangsrechnung_position AS PERMISSIVE FOR ALL TO - USING ((EXISTS ( SELECT 1
...
CREATE POLICY allow_all_calendar_events ON public.calendar_events AS PERMISSIVE FOR ALL TO - USING (true) WITH CHECK (true);
...
CREATE POLICY tenant_isolation ON public.communications AS PERMISSIVE FOR ALL TO - USING ((tenant_id = current_setting('app.tenant_id'::text, true)));
DROP POLICY IF EXISTS tenant_isolation_company_settings ON public.company_settings;
CREATE POLICY tenant_isolation_company_settings ON public.company_settings AS PERMISSIVE FOR ALL TO - USING ((tenant_id = current_setting('app.tenant_id'::text, true))) WITH CHECK ((tenant_id = current_setting('app.tenant_id'::text, true)));
DROP POLICY IF EXISTS tenant_isolation_complaints ON public.complaints;
CREATE POLICY tenant_isolation_complaints ON public.complaints AS PERMISSIVE FOR ALL TO - USING ((tenant_id = current_setting('app.tenant_id'::text, true))) WITH CHECK ((tenant_id = current_setting('app.tenant_id'::text, true)));
...
CREATE POLICY email_templates_all ON public.email_templates AS PERMISSIVE FOR ALL TO - USING (true) WITH CHECK (true);
DROP POLICY IF EXISTS tenant_isolation ON public.events;
CREATE POLICY tenant_isolation ON public.events AS PERMISSIVE FOR ALL TO - USING (((tenant_id)::text = current_setting('app.tenant_id'::text, true)));
...
CREATE POLICY "Allow full access to feature_flags" ON public.feature_flags AS PERMISSIVE FOR ALL TO - USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow full access to import_job_rows" ON public.import_job_rows AS PERMISSIVE FOR ALL TO - USING (true) WITH CHECK (true);
DROP POLICY IF EXISTS "Allow full access to import_jobs" ON public.import_jobs;
CREATE POLICY "Allow full access to import_jobs" ON public.import_jobs AS PERMISSIVE FOR ALL TO - USING (true) WITH CHECK (true);
...
CREATE POLICY public_all_inquiries_final ON public.inquiries AS PERMISSIVE FOR ALL TO - USING (true) WITH CHECK (true);
DROP POLICY IF EXISTS tenant_isolation_inquiries ON public.inquiries;
CREATE POLICY tenant_isolation_inquiries ON public.inquiries AS PERMISSIVE FOR ALL TO - USING (((tenant_id)::text = current_setting('app.tenant_id'::text, true))) WITH CHECK (((tenant_id)::text = current_setting('app.tenant_id'::text, true)));
...
CREATE POLICY public_all_items_final ON public.items AS PERMISSIVE FOR ALL TO - USING (true) WITH CHECK (true);
...
CREATE POLICY tenant_isolation_items ON public.items AS PERMISSIVE FOR ALL TO - USING (((tenant_id)::text = current_setting('app.tenant_id'::text, true))) WITH CHECK (((tenant_id)::text = current_setting('app.tenant_id'::text, true)));
...
CREATE POLICY tenant_isolation ON public.konto AS PERMISSIVE FOR ALL TO - USING ((tenant_id = current_setting('app.tenant_id'::text, true)));
DROP POLICY IF EXISTS "Allow all actions for public" ON public.kostenposten;
CREATE POLICY "Allow all actions for public" ON public.kostenposten AS PERMISSIVE FOR ALL TO - USING (true) WITH CHECK (true);
...
CREATE POLICY analyse_read ON public.kpi_snapshots AS PERMISSIVE FOR SELECT TO - USING (true);
...
CREATE POLICY "Enable all for public on kvp_items" ON public.kvp_items AS PERMISSIVE FOR ALL TO - USING (true);
...
CREATE POLICY "Allow all actions for public" ON public.steuerprofil AS PERMISSIVE FOR ALL TO - USING (true) WITH CHECK (true);
...
CREATE POLICY tenant_isolation_ui_events ON public.ui_events AS PERMISSIVE FOR ALL TO - USING ((tenant_id = current_setting('app.tenant_id'::text, true))) WITH CHECK ((tenant_id = current_setting('app.tenant_id'::text, true)));
...
CREATE POLICY "Allow all actions for public" ON public.zahlung AS PERMISSIVE FOR ALL TO - USING (true) WITH CHECK (true);
