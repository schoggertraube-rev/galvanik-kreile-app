...
**Massgeblicher Steuerungsstand: 2026-09-08.** `main` ist die einzige Lieferwahrheit. Der folgende
...
| F1.5 Order-to-Cash | A sowie B/B2 geliefert; C Warenausgang/Gate und D UI sind offen |
