...
| F1.5 Order-to-Cash | A+B/B2+C+D+D.1 geliefert. C wurde mit PR #79 als Merge-Commit `b94821ca56634bcf75e8d5ddda130241bb75b9bf`, D mit PR #80 als Merge-Commit `001a7698b9ea4edff881ed56ea110832e9de7a46` und D.1 (D-UI-F15-004A, Phillip-`Ware raus`-Griff) mit PR #81 als Merge-Commit `bf17e8c5562ca772696176fabf4963ece683b88b` integriert. T (Supabase-CLI-Pin) ist der aktuelle letzte F1.5-Kandidat. Kein F1.5-Gesamt-PASS vor T-Merge. |
