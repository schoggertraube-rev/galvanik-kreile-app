...
- **Aktuell dran:** das kleine Governance-/Automations-Abschlusspaket auf `gov/kreile-automation-closeout-20260909`. Es versioniert ausschließlich die freigegebenen Agenten-, Skill-, Hook- und Leitplanken-Dateien; es ändert keinen Produktpfad.
- **Nächstes Produktpaket nach diesem Governance-Abschluss:** F1.5-C `recordGoodsOut` + Gate. Danach bleibt F1.5-D UI offen. F1.5-A + B/B2 sind geliefert.
