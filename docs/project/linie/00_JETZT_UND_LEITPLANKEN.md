...
- **Aktuell dran:** F1.5-D.1 gemaess D-UI-F15-004A: den Phillip-V4-Griff `Ware raus` ueber einen engen Werkstatt-Port an den gelieferten OrderOverlay-Fluss binden; ausschliesslich echte `fertig`-Auftraege anbieten.
- **Nächster Schritt:** D.1 als einen Draft-PR-Kandidaten einfrieren, Real-E2E sowie CI/Preview am Exact-SHA belegen und unabhaengig pruefen lassen. T bleibt danach offen; kein F1.6- oder Nebenpaket vorziehen.
