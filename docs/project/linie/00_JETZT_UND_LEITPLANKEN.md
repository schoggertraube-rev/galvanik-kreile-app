...
- **Aktuell dran:** F1.5-T: Supabase CLI exakt und reproduzierbar lokal auf `2.111.0` sperren; CI und Quality duerfen sie nicht zur Laufzeit aus dem Netz nachinstallieren.
- **Nächster Schritt:** T als einen Draft-PR-Kandidaten einfrieren, lokale Positiv-/Negativbelege sowie CI/Preview am Exact-SHA belegen und unabhaengig pruefen lassen. Kein F1.5-Gesamt-PASS vor T-Merge; kein F1.6- oder Nebenpaket vorziehen.
