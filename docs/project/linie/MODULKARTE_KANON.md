...
bleibt einzige Daten-/Auth-/Storage-Wahrheit. Microsoft/Azure ist die
strategische Plattformrolle für M365 Graph, Foundry, Speech und optional
technische Dokumentvorverarbeitung; eine konkrete Capability bleibt dennoch
bis Region-, Quota-, Kosten-, Consent- und Real-E2E-Beleg geschlossen.
Gemini und Klippa sind supersedierte Legacy-Quarantäne, keine aktivierbaren
Pfade. Direkte OpenAI API, Mollie, Google Maps oder weitere Anbieter benötigen
jeweils die in D-ARCH-012 genannte neue Entscheidung beziehungsweise
Reihenfolge. Diese Kante beschreibt Anschlussgrenzen und behauptet keine neue
Produktfähigkeit.

Dokumentenintelligenz und semantische Suche sind keine eigene Datenwahrheit.
Sie dürfen nur über berechtigte öffentliche Read-Ports arbeiten, liefern
