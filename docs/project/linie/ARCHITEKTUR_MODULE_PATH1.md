...
- **F1.5 A+B/B2+C+D** sind geliefert; C mit PR #79, D mit PR #80. **D.1 ist aktueller Kandidat, T bleibt offen.** Ab S1 gilt ohne Ausnahme: **kein Feature-Bau, der die Naht-Gates rot lässt.**
