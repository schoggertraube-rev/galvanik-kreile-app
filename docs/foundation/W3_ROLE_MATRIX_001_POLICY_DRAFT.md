...
`6cbc21f86ce776966983a5e4b33a6984a60ed5a6`; any W3-scope code change after
that commit requires a new binding and re-run of this draft's tests. The current W3
